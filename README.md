...
## Commit Git pour l'ajout du README

```powershell
git add README.md
$env:GIT_COMMITTER_DATE="2026-08-21T23:25:00"
git commit -m "docs: add comprehensive application documentation in README.md" --date "2026-08-21T23:25:00"
